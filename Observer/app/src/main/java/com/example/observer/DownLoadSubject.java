...
public class DownLoadSubject implements Subject<Integer> {
    private List<Observers<Integer>> observers;
    ...
    @Override
    public void registerObserver(Observers<Integer> observer) {
    ...
    @Override
    public void removeObserver(Observers<Integer> observer) {
    ...
    public void notifyObservers() {//遍历队列，通知观察者更新
        for (Observers<Integer> observer : observers) {
